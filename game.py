...
# Bullet
bullet_img = pygame.transform.scale(pygame.image.load(os.path.join("bullet.png")), (10, 10))
# Background
background = pygame.transform.scale(pygame.image.load(os.path.join("desert_BG.png")), (win_width, win_height))
# Tower
